...
public class GeometryUtils {
    ...
    public static Position calculateByDirection(Double baseLatitude, Double baseLongitude, double distance,
                                                Double bearing) {
        ...
        return new Position(toDegree(latitude), toDegree(longitude));
    }
